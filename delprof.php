...
session_start();
    ...
    if (!$res) {
        ...
        while ($row = $res->fetch_assoc()) {
             ...
             $buy=$row['orderpercent'];


if($buy<50)$per=0.2;
if(100>$buy && $buy>50)$per=0.3;
if(100<$buy)$per=0.5;
$nn=($buy)*$per;
...
$idorder[]=$row['orderid'];
    ...
    try{
        ...
        $namedata1=[];
        $idorder1=[];
        $qryStr1 = "SELECT * FROM `order` WHERE namedelivery='marah@gmail.com'";
    ...
    if (!$res1) {
        ...
        while ($row = $res1->fetch_assoc()) {
             ...
             $buy1=$row['orderpercent'];


if($buy1<50)$per1=0.2;
if(100>$buy1 && $buy1>50)$per1=0.3;
if(100<$buy1)$per1=0.5;
$nn1=($buy1)*$per1;


$data1[]=$nn1;
$idorder1[]=$row['orderid'];
           $namedata1=$row['namedelivery'];
...
<div class="d-flex align-items-center justify-content-between">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="delprof.php" class="active">
              <i class="bi bi-circle"></i><span>Delivery</span>
            </a>
          </li>
          <!-- <li>
  ...
  <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Profit from all delivery</h5>
...
new Chart(document.querySelector('#doughnutChart'), {
                    type: 'doughnut',
                    data: {
                      labels: <?php echo json_encode($idorder); ?>,
                      datasets: [{
...
<div>
<h4 class="card-title" >These are the profits of each of the delivery</h4>        
            </div>
              ...
              <script>
                document.addEventListener("DOMContentLoaded", () => {
                  new Chart(document.querySelector('#pieChart'), {
                    type: 'pie',
                    data: {
                      labels: <?php echo json_encode($idorder1); ?>,
                      datasets: [{
                        label: 'My First Dataset',
