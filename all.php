...
<li class="nav-item">
      <a class="nav-link " href="all.php" >
          ...
          <i class="bi bi-card-list" ></i><span>Users</span>
        </a>
...
<table class="rwd-table">
    ...
    // $r=$row["productname"];
            ...
            <td>
                ...
                <td><?php echo $row["userplace"]; ?>

                   </td>
                <td>0<?php echo $row["userphone"]; ?>
                </td>
