...
//
            ...
            $qryStr = "select * from sellers where flag_req=1";
            $res = $db->query($qryStr);
            ...
            for ($i = 0; $i < $res->num_rows; $i++) {
                $row = $res->fetch_object();
                    ...
                    $qryStr = "UPDATE `sellers` SET  `flag_req`= 0  WHERE `selleremail`='" .$b. "'";
...
<table class="rwd-table">
    ...
    $query = "select * from sellers where flag_req=1 ";
    ...
    <form   method="post"  >
            <tr> 
            <td>  
                    <input type="text" style="width:160px "  name="email" id="email"  value="<?php echo $row["selleremail"]; ?>"readonly>
            ...
            <td>
                ...
                <td><?php echo $row["sellerplace"]; ?>

                   </td>
                <td>0<?php echo $row["sellerphone"]; ?>
                </td>
                <td><?php echo $row["sellercard"]; ?>

                    </td>
                <td>
                    <?php echo $row["suparmarketname"]; ?>
                   </td>
